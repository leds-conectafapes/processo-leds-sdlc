...
Identificar quem sentirá o impacto da solução e quais suas características.
...
*   **Ferramenta**: Uso do Figma para prototipação de baixa fidelidade e validação rápida do fluxo de empréstimo.
